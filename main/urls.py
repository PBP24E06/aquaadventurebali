...
from main.views import show_main, login_user, logout_user, register, checkout, request_admin, delete_product, edit_product, all_review, request_admin, create_review, product_detail, profile_view, edit_profile
